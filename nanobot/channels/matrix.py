...
TYPING_NOTICE_TIMEOUT_MS = 30000
TYPING_KEEPALIVE_INTERVAL_MS = 20000
...
MATRIX_MARKDOWN = create_markdown(
    escape=True, plugins=["table", "strikethrough", "url", "superscript", "subscript"]
)
...
def _filter_matrix_html_attribute(tag: str, attr: str, value: str) -> str | None:
    ...
    if tag == "code" and attr == "class":
        classes = [
            ...
            if c.startswith("language-") and (not c.startswith("language-_"))
        ]
        ...
        try:
            ...
            if candidates:
                ...
                for path in candidates:
                    if fail := (
                        await self._upload_and_send_attachment(
